...
from loss.make_loss import make_loss_air
from loss.make_loss import make_loss_ground
from loss.make_loss import make_loss_stage2
...
if __name__ == '__main__':
    ...
    # print(num_classes,camera_num,view_num,'number')
    # import pdb
    # pdb.set_trace()
    loss_func, center_criterion = make_loss(cfg, num_classes=num_classes)

    loss_fn_air= make_loss_air(cfg, num_classes=num_classes)
    loss_fn_ground = make_loss_ground(cfg, num_classes=num_classes)
    loss_fn_stage2= make_loss_stage2(cfg, num_classes=num_classes)
    ...
    do_train_stage2(
        ...
        scheduler_2stage,
        loss_func,
        num_query, args.local_rank,loss_fn_air,loss_fn_ground,loss_fn_stage2
    )