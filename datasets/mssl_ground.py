...
import pickle
class mssl_ground(BaseImageDataset):
    """
    Market1501
    Reference:
    ...
    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        super(mssl_ground, self).__init__()
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.train_dir = osp.join(self.dataset_dir, 'bounding_box_train_ground')
