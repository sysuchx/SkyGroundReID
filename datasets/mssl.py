...
class mssl(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        ...
        if cfg.TEST.EVAL_MODE=='DDC':
            print("Evaluation Protocols: Dual-Domain Cross Mode.")
            self.query_dir = osp.join(self.dataset_dir, 'query')
        elif cfg.TEST.EVAL_MODE=='S2G':
            print("Evaluation Protocols: Syk-Ground Mode.")
            self.query_dir = osp.join(self.dataset_dir, 'query_air')
        elif cfg.TEST.EVAL_MODE == 'G2S':
            print("Evaluation Protocols: Ground-Sky Mode.")
            self.query_dir = osp.join(self.dataset_dir, 'query_ground')
